...
public class mymethod {
	...
	static void musicData() {
		...
		String[] singer = mydata.singer;
		String[] album = mydata.album;
	...
	static void detailData() {
		...
		System.out.print("선택: ");
		int key = sc.nextInt();
		String mtitle = mydata.title[key-1];
		String singer = mydata.singer[key-1];
		String album = mydata.album[key-1];
		String state = mydata.state[key-1];
		int modify = mydata.modify[key-1];
